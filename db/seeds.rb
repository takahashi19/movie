...
('ハリー・ポッターと死の秘宝 PART1','3人の絆にも亀裂が生じ，一方、ヴォルデモートの影響力は、ついには魔法省ばかりかホグワーツまでもが支配下におかれてしまう。','960283305','https://dl.dropboxusercontent.com/s/2jeh6zt0dw89cb5/harrypotter_andthedeathlyhallows1.jpg'),
('ハリー・ポッターと死の秘宝 PART2','魔法学校ホグワーツさえも戦場となり、闇の帝王ヴォルデモートとハリー・ポッターの一騎打ちの行方を壮大なスケールで描き出す。','1341511219','https://dl.dropboxusercontent.com/s/c5a7i0cmmmu8kjp/harrypotterandthedeathlyhallowspart2.jpg'),
('ハリー・ポッターと謎のプリンス','最終決戦が迫っていることを知っているダンブルドア校長は、ハリーに来たるべき戦いにむけての準備を施していく。','934416487','https://dl.dropboxusercontent.com/s/0u5hoo6bwteacmf/harrypotter_and%20the%20half-blood%20prince.jpg'),
('ハリー・ポッターと不死鳥の騎士団','魔法省は学校全体の監視役を送り込んでくる。一方、ヴォルデモートは仲間を集め、ハリーたちを陥れようと暗躍し始めていた…','939885929','https://dl.dropboxusercontent.com/s/ilye2j8iamasf9t/harrypotter_and%20theorderofthe%20phoenix.jpg'),
('ファインディング・ドリー','前作から1年後。忘れんぼうのドリーが思い出した“家族の思い出”を探るうちに、禁断の場所=人間の世界へとたどり着き……','1028644677','https://dl.dropboxusercontent.com/s/2y6nlym6jvf0r81/findingdory.jpg'),
('ファインディング・ニモ','打ちひしがれるマーリンだったが、陽気なナンヨウハギ、ドリーの助けを借りてニモを取り戻す旅へと出るのだった。','936743261','https://dl.dropboxusercontent.com/s/7naih0o2btdzu94/findingnemo.jpg'),
('ホビット 決戦のゆくえ','エルフは財宝の分配を要求すると、トーリンはこれを頑なに拒否してしまう。衝突を回避しようと行動に出るビルボだったが…','955119788','https://dl.dropboxusercontent.com/s/wdmgejohjrmognl/hobbit_thebattle%20ofthefive%20armies.jpg'),
('ホビット 思いがけない冒険','恐るべきスマウグに奪われたドワーフの王国を奪還する危険な旅に加わったホビット族のビルボ・バギンズが辿る壮大な冒険。','1017003568','https://dl.dropboxusercontent.com/s/0cd1nkhvgwbb84u/hobbit_an%20unexpectedjourney.jpg'),
('ホビット 竜に奪われた王国','過酷な旅を続ける一行は、闇の森で獰猛な巨大クモに襲われ、間一髪のところをレゴラス率いるエルフたちに助けられるのだったが…','960366855','https://dl.dropboxusercontent.com/s/w6egbijvhc0v2jl/hobbit_theddesolationof%20smaug.jpg'),
('ミニオンズ','リーダーのケビンは、スチュアート、ボブと一緒に新たなボスを探す旅に出ることに。女悪党スカーレットと出会うのだったが…。','1157275017','https://dl.dropboxusercontent.com/s/0uk62vr96ke4oew/minions.jpg'),
('ライオン・キング','シンバは国を追われたが、恋心を抱く幼なじみのナラに、故国の窮状を訴えられ皆を引き連れ帰郷、スカーと一対一の決闘に臨む……','987483777','https://dl.dropboxusercontent.com/s/l080jxiva4snbm1/lionking.jpg'),
('ロード・オブ・ザ・リング/王の帰還','長らく国交が途絶えていたローハンの人々も立ち上がる。フロドとサムもモルドールの滅びの山を目指して旅を再開するのだったが…','1119929521','https://dl.dropboxusercontent.com/s/hkyagc79r6nx99l/loadofthering_thereturnoftheking.jpg'),
('ロード・オブ・ザ・リング/二つの塔','3人は、メリーとピピンを追う途中で、国王がサルマンの呪いに苦しめられているローハン王国へとやって来る…。','926047111','https://dl.dropboxusercontent.com/s/8g3klslicg7sp09/lordoftherings_the%20twotowers.jpg'),
